...
<form id="signup" action="TabletServlet" method="post">
  ...
  <h2></h2>
  <fieldset>
   <legend>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add Pre Workout</legend>
   <ol>
   <li>
     <label for="state">Name</label>
     <select name="city" id="state">
      <option selected>Psychotic pre Workout</option>
      <option>Ripped Pre Workout</option>
      <option>MB 200 Pre Workout</option>
      <option>Roar Pre Workout</option>
     </select>
    </li>   
