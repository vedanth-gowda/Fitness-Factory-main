...
<table width="75%" border="1">
 ...
 <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Brand :</strong>
       Optimum Nutrition</font><input type="hidden" name="modelNo" value=" Optimum Nutrition">
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Product :</strong>
        100% gold standard Whey Protein </font><input type="hidden" name="description" value=" 100% gold standard Whey Protein"></p>
      ...
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Image :</strong><input type="hidden" name="img" ><img src="Whey proteins/ONwhey.png"  alt="image"  width="150"height="150"/>
      <h:link  outcome="ShoppingCart"> 
      <h:graphicImage value="new images/fflogo.png" style="border:none"/>
      </h:link></font></p>
      <p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Price:</strong>
       &#x20B9; 3500.00  </font><input type="hidden" name="price" value="3500"></p><input type="hidden" name="action" value="add"><input type="submit" name="addToCart" value="Add To Cart">
      </form></td>
